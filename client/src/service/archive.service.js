...
export default class ArchiveService {
    ...
    newArchive = (project_id, folder_id, archive) => this.appi.post(`/archive/new/project/${project_id}/${folder_id}`, archive)
    ...
    deleteArchive = (project_id, folder_id, archive_id) => this.api.delete(`/archive/${archive_id}/${folder_id}/delete/project/${project_id}/${folder_id}`)
}