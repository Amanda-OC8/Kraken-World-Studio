      ...
      return (
        ...
        <>
          ...
          <main>
            ...
            <Route path="/projects/:project_id/character/:character_id/character/details" exact render={props => <CharacterDetail theUser={this.state.loggedInUser} showModal={false} {...props} />} />
            <Route path="/projects/:project_id/:character_id/character/edit" exact render={props => <CharacterDetail theUser={this.state.loggedInUser} showModal={true} {...props} />} />
