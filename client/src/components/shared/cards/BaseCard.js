            ...
            <Col md={{ span: 4 }} className="justifiy-content-center">
                <Card className="dark-mode">
                    <Card.Body >
                        ...
                        {this.props.typeCard === "character" && <Link className="btn-shape btn-dark-mode-config" to={`/projects/${this.props.projectId}/character/${this.props.id}/character/details`}>Detalles</Link>}
